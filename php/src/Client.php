...
namespace APIVerve\Filesizeformatter;
...
/**
 * Client for the File Size Formatter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/filesizeformatter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/filesizeformatter';
    ...
    private const VALIDATION_RULES = [
        ...
        'precision' => ['type' => 'integer', 'required' => false, 'min' => 0, 'max' => 10],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\FilesizeformatterClient] {$message}\n";
        }
    }
}
