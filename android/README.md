# File Size Formatter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:filesizeformatter-api:1.1.14'
}
```
...
```java
import com.apiverve.filesizeformatter.FileSizeFormatterAPIClient;
import com.apiverve.filesizeformatter.APIResponse;
import com.apiverve.filesizeformatter.APIException;

// Initialize the client
FileSizeFormatterAPIClient client = new FileSizeFormatterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("bytes", 1073741824);
    parameters.put("unit", "GB");
    parameters.put("precision", 2);
    parameters.put("standard", "binary");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/filesizeformatter](https://docs.apiverve.com/ref/filesizeformatter)
...
- **Documentation:** [https://docs.apiverve.com/ref/filesizeformatter](https://docs.apiverve.com/ref/filesizeformatter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/filesizeformatter-api/issues)
