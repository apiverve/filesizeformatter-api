...
namespace APIVerve.API.FileSizeFormatter
{
    ...
    /// <summary>
    /// Client for the FileSizeFormatter API
    /// </summary>
    public class FileSizeFormatterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/filesizeformatter";
        ...
        {
            { "bytes", new ValidationRule { Type = "integer", Required = true, Min = 0 } },
            { "unit", new ValidationRule { Type = "string", Required = false } },
            { "precision", new ValidationRule { Type = "integer", Required = false, Min = 0, Max = 10 } },
            { "standard", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public FileSizeFormatterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FileSizeFormatterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FileSizeFormatterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, FileSizeFormatterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(FileSizeFormatterQueryOptions options)
        {
        ...
        public ResponseObj Execute(FileSizeFormatterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(FileSizeFormatterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(FileSizeFormatterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(FileSizeFormatterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(FileSizeFormatterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(FileSizeFormatterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(FileSizeFormatterQueryOptions options)
        {
