...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/filesizeformatter',
        'Source': 'https://github.com/apiverve/filesizeformatter-api',
        'Bug Tracker': 'https://github.com/apiverve/filesizeformatter-api/issues'
    },
    classifiers=[
