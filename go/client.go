...
const (
	baseURL        = "https://api.apiverve.com/v1/filesizeformatter"
	defaultTimeout = 30 * time.Second
)

// Client is the File Size Formatter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new File Size Formatter API client.
...
// Execute makes a request to the File Size Formatter API with typed parameters.
//
