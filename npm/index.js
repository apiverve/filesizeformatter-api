...
class filesizeformatterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/filesizeformatter');
        }
        ...
        this.validationRules = {"bytes":{"type":"integer","required":true,"min":0},"unit":{"type":"string","required":false},"precision":{"type":"integer","required":false,"min":0,"max":10,"default":2},"standard":{"type":"string","required":false,"default":"binary"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/filesizeformatter`);
        }
    }
...
module.exports = filesizeformatterWrapper;
